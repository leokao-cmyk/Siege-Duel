...
const ENEMY_TYPES = {
  grunt:    { name:'Grunt', hp:52, speed:1.55, livesLost:5, cost:15, endBonus:15, towerDps:13, color:'#8bcf5a', dark:'#3f6b28',
    desc:'Balanced all-rounder with no special tricks.' },
  runner:   { name:'Runner', hp:27, speed:3.4, livesLost:3, cost:12, endBonus:15, towerDps:8, color:'#ffdd55', dark:'#8a7a1f',
    desc:'Very fast but fragile — rushes past slow defenses.' },
  tank:     { name:'Tank', hp:185, speed:1.05, livesLost:12, cost:45, endBonus:30, towerDps:33, color:'#a9713f', dark:'#5a3c1f',
  ...
  shield:   { name:'Shield Bot', hp:68, shieldHp:55, speed:1.2, livesLost:6, cost:35, endBonus:15, towerDps:17, color:'#5599dd', dark:'#274a70',
  ...
  bomber:   { name:'Bomber', hp:80, speed:1.9, livesLost:18, cost:30, endBonus:45, towerDps:23, color:'#ff6644', dark:'#8a2f18',
    explodeDamage:55, explodeRadius:1.8,
    desc:'Explodes on death, dealing a big burst of damage to all nearby towers.' },
  splitter: { name:'Splitter', hp:72, speed:1.45, livesLost:6, cost:38, endBonus:15, towerDps:14, color:'#cc66ff', dark:'#5a2680', splitInto:'splitling', splitCount:2,
  ...
  broodcarrier: { name:'Brood Carrier', hp:95, speed:1.15, livesLost:10, cost:78, endBonus:20, towerDps:12, color:'#8a7a3a', dark:'#3a3018', splitInto:'grunt', splitCount:3,
