...
const ENEMY_TYPES = {
  ...
  tank:     { name:'Tank', hp:185, speed:1.05, livesLost:12, cost:35, endBonus:30, towerDps:33, color:'#a9713f', dark:'#5a3c1f',
  ...
  juggernaut: { name:'Juggernaut', hp:340, speed:0.5, livesLost:20, cost:135, endBonus:40, towerDps:28, color:'#8a95a3', dark:'#3a3f47',
  ...
  bomber:   { name:'Bomber', hp:80, speed:1.9, livesLost:18, cost:25, endBonus:45, towerDps:23, color:'#ff6644', dark:'#8a2f18',
    explodeDamage:55, explodeRadius:1.8,
    desc:'Explodes on death, dealing a big burst of damage to all nearby towers.' },
  splitter: { name:'Splitter', hp:72, speed:1.45, livesLost:6, cost:35, endBonus:15, towerDps:14, color:'#cc66ff', dark:'#5a2680', splitInto:'splitling', splitCount:2,
  ...
  broodcarrier: { name:'Brood Carrier', hp:95, speed:1.15, livesLost:10, cost:65, endBonus:20, towerDps:12, color:'#8a7a3a', dark:'#3a3018', splitInto:'grunt', splitCount:3,
