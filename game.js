...
const ENEMY_TYPES = {
  grunt:    { name:'Grunt', hp:52, speed:1.55, livesLost:5, cost:11, endBonus:15, towerDps:13, color:'#8bcf5a', dark:'#3f6b28',
    desc:'Balanced all-rounder with no special tricks.' },
  runner:   { name:'Runner', hp:27, speed:3.4, livesLost:3, cost:9, endBonus:15, towerDps:8, color:'#ffdd55', dark:'#8a7a1f',
  ...
  bomber:   { name:'Bomber', hp:80, speed:1.9, livesLost:18, cost:23, endBonus:45, towerDps:23, color:'#ff6644', dark:'#8a2f18',
    explodeDamage:55, explodeRadius:1.8,
    desc:'Explodes on death, dealing a big burst of damage to all nearby towers.' },
  splitter: { name:'Splitter', hp:72, speed:1.45, livesLost:6, cost:29, endBonus:15, towerDps:14, color:'#cc66ff', dark:'#5a2680', splitInto:'splitling', splitCount:2,
  ...
  broodcarrier: { name:'Brood Carrier', hp:95, speed:1.15, livesLost:10, cost:59, endBonus:20, towerDps:12, color:'#8a7a3a', dark:'#3a3018', splitInto:'grunt', splitCount:3,
